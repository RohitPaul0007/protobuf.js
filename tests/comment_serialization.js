...
tape.test("by default, drop comments through de/serialization", function(test) {
    ...
    protobuf.load("tests/data/comment_serialization.proto", function(err, root) {
        ...
        let copy = protobuf.Root.fromJSON(root.toJSON());
        ...
        let rootService = root.lookupService("TestService");
        let copyService = copy.lookupService("TestService");
        ...
        let rootEnum = root.lookup("TestEnum");
        let copyEnum = copy.lookup("TestEnum");
...
tape.test("preserve comments through de/serialization if option set", function(test) {
    ...
    protobuf.load("tests/data/comment_serialization.proto", function(err, root) {
        ...
        let toJSONOptions = {keepComments: true};
        let copy = protobuf.Root.fromJSON(root.toJSON(toJSONOptions));
