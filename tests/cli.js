...
function cliTest(test, testFunc) {
    ...
    let savedResolveFilename = Module._resolveFilename;
...
tape.test("pbjs generates static code", function(test) {
    cliTest(test, function() {
        let root = protobuf.loadSync("tests/data/cli/test.proto");
        root.resolveAll();

        let staticTarget = require("../cli/targets/static");
        ...
        staticTarget(root, {
            ...
            let OneofContainer = protobuf.roots.default.OneofContainer;
            let Message = protobuf.roots.default.Message;
            ...
            let obj1 = OneofContainer.toObject(OneofContainer.fromObject(obj));
            ...
            let root = protobuf.loadSync("tests/data/cli/test.proto");
            let OneofContainerDynamic = root.lookup("OneofContainer");
            let instance = new OneofContainer();
            instance.messageInOneof = new Message();
            instance.messageInOneof.value = 42;
            instance.regularField = "abc";
            instance.enumField = 0;
            let instance1 = OneofContainerDynamic.toObject(OneofContainerDynamic.fromObject(instance));
            ...
            let defaultTypeUrl = Message.getTypeUrl();
            let customTypeUrl = Message.getTypeUrl("example.com");
